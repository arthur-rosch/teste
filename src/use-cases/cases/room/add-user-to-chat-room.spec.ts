import { InMemoryNotificationRepository, InMemoryUserRepository } from "@/repository/in-memory";
import { InMemoryRoomRepository } from "@/repository/in-memory/in-memory-room-repository";
import Chance from "chance";
import { beforeEach, describe, expect, it, vi } from "vitest";
import { ErrorHandler } from "@/http/middleware/errorResponse";
import { AddUserToRoomUseCase } from "./add-user-to-chat-room";
...
describe("Added User to Room Use Case Test", () => {
  const user = {
    id: data.ownerId,
    name: chance.name(),
    email: chance.email(),
  ...
  it("should successfully added user from room", async () => {
  ...
  it("should return error, user added is not found", async () => {
