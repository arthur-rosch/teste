...
var edit_receivable_exports = {};
__export(edit_receivable_exports, {
  EditReceivableUseCase: () => EditReceivableUseCase
});
module.exports = __toCommonJS(edit_receivable_exports);
...
var EditReceivableUseCase = class {
  ...
  execute(_0) {
    return __async(this, arguments, function* ({
      ...
      const receivable = yield this.financialRepository.editReceivable(
        receivableId,
        {
          amountToReceive,
          serviceEndDate,
