...
// src/use-cases/cases/financial/receivable/create-receivable.spec.ts
...
(0, import_vitest.describe)("CreateReceivableUseCase", () => {
  (0, import_vitest.it)("should create a receivable successfully", () => __async(exports, null, function* () {
    ...
    import_vitest.vi.spyOn(financialRepository, "createReceivable").mockResolvedValue({
      id: "receivable-id-1",
      amountToReceive: 1e3,
    ...
    (0, import_vitest.expect)(financialRepository.createReceivable).toHaveBeenCalledWith({
      amountToReceive: 1e3,
      serviceStartDate: /* @__PURE__ */ new Date("2023-01-01"),
      serviceEndDate: /* @__PURE__ */ new Date("2023-12-31"),
      serviceProvided: "Consulting",
