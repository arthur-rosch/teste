...
// src/use-cases/cases/financial/receivable/get-all-receivable-by-user-id.spec.ts
...
// src/use-cases/cases/financial/receivable/get-all-receivable-by-user-id.ts
var GetAllReceivableByUserIdUseCase = class {
  ...
  execute(_0) {
    return __async(this, arguments, function* ({
      ...
      const receivables2 = yield this.financialRepository.getAllReceivableByFinancialId(
        financialExists.id
      );
      return receivables2;
    });
...
(0, import_vitest.describe)("GetAllReceivableByUserIdUseCase", () => {
  (0, import_vitest.it)("should return all receivables for a user", () => __async(exports, null, function* () {
    ...
    (0, import_vitest.expect)(result).toEqual(receivables);
