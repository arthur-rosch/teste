...
// src/use-cases/cases/financial/expense/delete-expense.spec.ts
...
(0, import_vitest.describe)("DeleteExpenseUseCase", () => {
  (0, import_vitest.it)("should delete an expense successfully", () => __async(exports, null, function* () {
    ...
    import_vitest.vi.spyOn(financialRepository, "getExpenseById").mockResolvedValue(
      expenseData
    );
    import_vitest.vi.spyOn(financialRepository, "deleteExpense").mockResolvedValue(
      expenseData
    );
    ...
    (0, import_vitest.expect)(result).toEqual(expenseData);
    ...
    (0, import_vitest.expect)(financialRepository.getExpenseById).toHaveBeenCalledWith(
      expenseData.id
    );
    (0, import_vitest.expect)(financialRepository.deleteExpense).toHaveBeenCalledWith(
      expenseData.id
    );
  }));
  ...
  (0, import_vitest.it)("should throw an error if expense is not found", () => __async(exports, null, function* () {
    import_vitest.vi.spyOn(userRepository, "getUserById").mockResolvedValue(user);
    import_vitest.vi.spyOn(financialRepository, "getFinancial").mockResolvedValue(
      financialRegistration
    );
    import_vitest.vi.spyOn(financialRepository, "getExpenseById").mockResolvedValue(null);
    yield (0, import_vitest.expect)(
      sut.execute({
        userId: user.id,
        expenseId: expenseData.id,
