...
// src/use-cases/cases/financial/expense/get-all-expense-by-user-id.ts
var GetAllExpenseByUserIdUseCase = class {
  ...
  execute(_0) {
    return __async(this, arguments, function* ({ userId }) {
      ...
      const clients = yield this.financialRepository.getAllExpenseByFinancialId(
        financialExists.id
      );
      return clients;
    });
...
// src/use-cases/cases/financial/expense/get-all-expense-by-user-id.spec.ts
...
var expenses = [
  {
    ...
    amount: 500,
    recurringMonth: 12,
    contractStartDate: /* @__PURE__ */ new Date("2023-01-01"),
    contractEndDate: /* @__PURE__ */ new Date("2023-12-31"),
  ...
  },
  {
    ...
    amount: 800,
    recurringMonth: 6,
    contractStartDate: /* @__PURE__ */ new Date("2023-02-01"),
    contractEndDate: /* @__PURE__ */ new Date("2023-07-31"),
    financialRegistrationId: financialRegistration.id
  }
];
(0, import_vitest.describe)("GetAllExpenseByUserIdUseCase", () => {
  (0, import_vitest.it)("should retrieve all expenses for a user successfully", () => __async(exports, null, function* () {
    ...
    import_vitest.vi.spyOn(
      financialRepository,
      "getAllExpenseByFinancialId"
    ).mockResolvedValue(expenses);
    const result = yield sut.execute({ userId: user.id });
    (0, import_vitest.expect)(result).toEqual(expenses);
    ...
    (0, import_vitest.expect)(financialRepository.getAllExpenseByFinancialId).toHaveBeenCalledWith(
  ...
  (0, import_vitest.it)("should throw an error if user is not found", () => __async(exports, null, function* () {
    ...
    yield (0, import_vitest.expect)(sut.execute({ userId: user.id })).rejects.toThrow(
