...
// src/use-cases/cases/financial/expense/create-expense.spec.ts
...
// src/use-cases/cases/financial/expense/create-expense.ts
var CreateUseCase = class {
  ...
  execute(_0) {
    return __async(this, arguments, function* ({
      ...
      const expense = yield this.financialRepository.createExpenses({
        type,
        amount,
        recurringMonth,
        contractEndDate,
...
(0, import_vitest.describe)("CreateUseCase", () => {
  (0, import_vitest.it)("should create an expense successfully", () => __async(exports, null, function* () {
    ...
    import_vitest.vi.spyOn(financialRepository, "createExpenses").mockResolvedValue(
      expenseData
    );
    ...
    (0, import_vitest.expect)(result).toEqual(__spreadValues({}, expenseData));
    ...
    (0, import_vitest.expect)(financialRepository.createExpenses).toHaveBeenCalledWith({
      type: expenseData.type,
      amount: expenseData.amount,
      recurringMonth: expenseData.recurringMonth,
      contractEndDate: expenseData.contractEndDate,
