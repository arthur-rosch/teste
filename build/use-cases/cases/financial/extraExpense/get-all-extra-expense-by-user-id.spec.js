...
// src/use-cases/cases/financial/extraExpense/get-all-extra-expense-by-user-id.ts
var GetAllExtraExpenseByUserIdUseCase = class {
  ...
  execute(_0) {
    return __async(this, arguments, function* ({
      ...
      const extraExpense = yield this.financialRepository.getAllExtraExpenseByFinancialId(
        financialExists.id
      );
      return extraExpense;
    });
...
// src/use-cases/cases/financial/extraExpense/get-all-extra-expense-by-user-id.spec.ts
...
var extraExpenses = [
  ...
  },
  {
    ...
    expenseType: "Travel",
    amount: 800,
    startDate: /* @__PURE__ */ new Date("2023-02-01"),
    endDate: /* @__PURE__ */ new Date("2023-03-31"),
    financialRegistrationId: financialRegistration.id
  }
];
(0, import_vitest.describe)("GetAllExtraExpenseByUserIdUseCase", () => {
  (0, import_vitest.it)("should retrieve all extra expenses for a user successfully", () => __async(exports, null, function* () {
    ...
    (0, import_vitest.expect)(result).toEqual(extraExpenses);
