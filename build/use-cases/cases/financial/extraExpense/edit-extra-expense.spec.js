...
// src/use-cases/cases/financial/extraExpense/edit-extra-expense.ts
var EditUseCase = class {
  ...
  execute(_0) {
    return __async(this, arguments, function* ({
      ...
      const expense = yield this.financialRepository.editExtraExpense(
        extraExpenseId,
        {
          amount,
          endDate,
...
// src/use-cases/cases/financial/extraExpense/edit-extra-expense.spec.ts
...
(0, import_vitest.describe)("EditUseCase", () => {
  (0, import_vitest.it)("should edit an extra expense successfully", () => __async(exports, null, function* () {
    ...
    import_vitest.vi.spyOn(financialRepository, "editExtraExpense").mockResolvedValue(
      extraExpenseData
    );
    const editedExtraExpenseData = __spreadProps(__spreadValues({}, extraExpenseData), {
      amount: 800,
      expenseType: "Travel"
    });
    ...
    (0, import_vitest.expect)(result).toEqual(editedExtraExpenseData);
    ...
    (0, import_vitest.expect)(financialRepository.editExtraExpense).toHaveBeenCalledWith(
      extraExpenseData.id,
      {
        amount: editedExtraExpenseData.amount,
        endDate: editedExtraExpenseData.endDate,
