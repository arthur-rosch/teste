...
// src/use-cases/cases/financial/client/delete-client.spec.ts
...
(0, import_vitest.describe)("DeleteClientUseCase", () => {
  (0, import_vitest.it)("should delete a client successfully", () => __async(exports, null, function* () {
    ...
    import_vitest.vi.spyOn(financialRepository, "deleteClient").mockResolvedValue(clientData);
    const result = yield sut.execute({
      userId: user.id,
      clientId: clientData.id,
      financialRegistrationId: financialRegistration.id
    });
    (0, import_vitest.expect)(result).toEqual(clientData);
    ...
    (0, import_vitest.expect)(financialRepository.deleteClient).toHaveBeenCalledWith(clientData.id);
  }));
