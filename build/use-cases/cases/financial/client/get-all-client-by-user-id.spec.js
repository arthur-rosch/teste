...
var GetAllClientByUserIdUseCase = class {
  ...
  execute(_0) {
    return __async(this, arguments, function* ({ userId }) {
      ...
      const clients2 = yield this.financialRepository.getAllClientByFinancialId(
        financialExists.id
      );
      return clients2;
    });
...
// src/use-cases/cases/financial/client/get-all-client-by-user-id.spec.ts
...
(0, import_vitest.describe)("GetAllClientByUserIdUseCase", () => {
  (0, import_vitest.it)("should get all clients successfully", () => __async(exports, null, function* () {
    ...
    (0, import_vitest.expect)(result).toEqual(clients);
    ...
    (0, import_vitest.expect)(financialRepository.getAllClientByFinancialId).toHaveBeenCalledWith(
