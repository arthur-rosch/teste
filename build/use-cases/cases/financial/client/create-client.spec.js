...
// src/use-cases/cases/financial/client/create-client.spec.ts
...
(0, import_vitest.describe)("CreateClientUseCase", () => {
  (0, import_vitest.it)("should create a client successfully", () => __async(exports, null, function* () {
    ...
    import_vitest.vi.spyOn(financialRepository, "createClient").mockResolvedValue(clientData);
    ...
    (0, import_vitest.expect)(financialRepository.createClient).toHaveBeenCalledWith({
      address: clientData.address,
      email: clientData.email,
      name: clientData.name,
      phone: clientData.phone,
