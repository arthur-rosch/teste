...
// src/use-cases/cases/annotation/get-by-user-id.spec.ts
...
var userRepository;
var sut;
(0, import_vitest.describe)("Get Annotations By User Id Use Case", () => {
  ...
  (0, import_vitest.it)("should be able to get annotations by user id", () => __async(exports, null, function* () {
    const { id } = yield createMockUser(userRepository);
    const annotation1 = yield annotationRepository.create({
      id: "1",
      color: "blue",
    ...
    const annotation2 = yield annotationRepository.create({
      id: "2",
      color: "green",
    ...
    const annotations = yield sut.execute({ userId: id });
    (0, import_vitest.expect)(annotations).toEqual([annotation1, annotation2]);
  }));
  (0, import_vitest.it)("should throw an error if user not found", () => __async(exports, null, function* () {
