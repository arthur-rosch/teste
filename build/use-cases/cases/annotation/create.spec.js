...
// src/use-cases/cases/annotation/create.spec.ts
...
function makeCreateAnnotation() {
  ...
  const notificationRepository2 = new NotificationRepository(prisma3);
  const notificationService2 = new SendNotification();
  const annotationRepository2 = new AnnotationRepository(prisma3);
  const userRepository2 = new UserRepository(prisma3);
  return new CreateAnnotationUseCase(notificationRepository2, notificationService2, annotationRepository2, userRepository2);
}
...
function makeDeleteAnnotation() {
  ...
  const annotationRepository2 = new AnnotationRepository(prisma3);
  const userRepository2 = new UserRepository(prisma3);
  return new DeleteAnnotationUseCase(notificationRepository2, notificationService2, annotationRepository2, userRepository2);
}
...
function makeGetByIdAnnotation() {
  ...
  const annotationRepository2 = new AnnotationRepository(prisma3);
  return new GetByIdUseCase(annotationRepository2);
}
...
var GetByUserIdUseCase = class {
  constructor(annotationRepository2, userRepository2) {
    this.annotationRepository = annotationRepository2;
    this.userRepository = userRepository2;
  }
  execute(_0) {
...
function makeGetByUserIdAnnotation() {
  ...
  const annotationRepository2 = new AnnotationRepository(prisma3);
  const userRepository2 = new UserRepository(prisma3);
  return new GetByUserIdUseCase(annotationRepository2, userRepository2);
}
...
function makeAddUserInProjectUseCase() {
  ...
  const notificationRepository2 = new NotificationRepository(prisma3);
  const notificationService2 = new SendNotification();
  const projectRepository = new ProjectRepository(prisma3);
  const userRepository2 = new UserRepository(prisma3);
...
var sut;
(0, import_vitest.describe)("Create Annotation Use Case", () => {
  (0, import_vitest.beforeEach)(() => {
    notificationRepository = new InMemoryNotificationRepository();
    notificationService = new SendNotification(), annotationRepository = new InMemoryAnnotationRepository();
  ...
  (0, import_vitest.it)("should be able to create annotation", () => __async(exports, null, function* () {
    const { id } = yield createMockUser(userRepository);
    const annotation = yield sut.execute({
      color: "blue",
      information: "This is a test annotation",
      title: "Test Annotation",
      userId: id
    });
    (0, import_vitest.expect)(annotation.id).toBeTruthy();
  }));
  (0, import_vitest.it)("should not be able to create annotation with wrong user id", () => __async(exports, null, function* () {
