...
// src/use-cases/cases/room/add-user-to-chat-room.spec.ts
...
var UserRepository = class {
  ...
  create(data2) {
    return __async(this, null, function* () {
      const { name, email, phone, gender, dateBirth, password } = data2;
...
var EditUser = class {
  ...
  execute(data2) {
    return __async(this, null, function* () {
      ...
      const updateUser = {
        name: data2.name || userAlreadyExists.name,
        email,
        phone: data2.phone || userAlreadyExists.phone,
        gender: data2.gender || userAlreadyExists.gender,
        dateBirth: data2.dateBirth || userAlreadyExists.dateBirth
      };
...
function makeEditUser() {
  ...
  const userRepository2 = new UserRepository(prisma2);
...
function editUser(req, res, next) {
  return __async(this, null, function* () {
    try {
      ...
      const data2 = querySchema.parse(req.body);
      const userusecase = makeEditUser();
      const newUser = yield userusecase.execute(data2);
...
var MessageRepository = class {
  ...
  saveMessage(data2) {
    return __async(this, null, function* () {
      const { content, userId, chatId } = data2;
...
var EmailTokenRepository = class {
  ...
  create(data2) {
    return __async(this, null, function* () {
      const { email, token, validated, attempts } = data2;
...
var NotificationRepository = class {
  ...
  create(data2) {
    return __async(this, null, function* () {
      return yield this.prisma.notification.create({ data: data2 });
    });
  }
  getUserId(userId) {
    return __async(this, null, function* () {
...
var CreateUser = class {
  ...
  execute(data2) {
    return __async(this, null, function* () {
      const { email, password, confirmPassword } = data2;
      const userAlreadyExists = yield this.userRepository.getUser({
        email
      });
      if (userAlreadyExists) {
...
function createUser(req, res, next) {
  return __async(this, null, function* () {
    try {
      ...
      const createUser2 = yield userusecase.execute(data2);
...
var CreateRoomUseCase = class {
  constructor(notificationRepository2, notificationService2, roomRepository2, userRepository2, chatRepository) {
    this.notificationRepository = notificationRepository2;
    this.notificationService = notificationService2;
    this.roomRepository = roomRepository2;
    this.userRepository = userRepository2;
...
function makeCreateRoomUseCase() {
  ...
  const notificationRepository2 = new NotificationRepository(prisma2);
  const notificationService2 = new SendNotification();
  const roomRepository2 = new RoomRepository(prisma2);
  const userRepository2 = new UserRepository(prisma2);
  const chatRepository = new ChatRepository(prisma2);
  return new CreateRoomUseCase(notificationRepository2, notificationService2, roomRepository2, userRepository2, chatRepository);
}
...
var DeleteRoomUseCase = class {
  constructor(notificationRepository2, notificationService2, chatRepository, roomRepository2, userRepository2) {
    this.notificationRepository = notificationRepository2;
    this.notificationService = notificationService2;
    this.chatRepository = chatRepository;
    this.roomRepository = roomRepository2;
...
function makeDeleteRoomUseCase() {
  ...
  const roomRepository2 = new RoomRepository(prisma2);
  const chatRepository = new ChatRepository(prisma2);
  return new DeleteRoomUseCase(notificationRepository2, notificationService2, chatRepository, roomRepository2, userRepository2);
}
...
function makeUpdateRoomUseCase() {
  ...
  const userRepository2 = new UserRepository(prisma2);
  const roomRepository2 = new RoomRepository(prisma2);
  return new UpdateRoomUseCase(roomRepository2, userRepository2);
}
...
function makeGetRoomByIdUseCase() {
  ...
  const roomRepository2 = new RoomRepository(prisma2);
  return new GetRoomByIdUseCase(roomRepository2);
}
...
var AddVideoRoomUseCase = class {
  ...
  execute(data2) {
    return __async(this, null, function* () {
      const { ownerId, roomId, roomLink } = data2;
...
function makeAddVideoRoom() {
  ...
  const roomRepository2 = new RoomRepository(prisma2);
  const userRepository2 = new UserRepository(prisma2);
  return new AddVideoRoomUseCase(roomRepository2, userRepository2);
}
...
function addVideoRoom(req, res, next) {
  return __async(this, null, function* () {
    try {
      ...
      const data2 = bodySchema.parse(req.body);
      const roomUseCase = makeAddVideoRoom();
      const result = yield roomUseCase.execute(data2);
...
function makeSendMessage() {
  ...
  const userRepository2 = new MessageRepository(prisma2);
...
function createAnnotation(req, res, next) {
  return __async(this, null, function* () {
    try {
      ...
      const annotation = yield annotationUseCase.execute(data2);
...
function deleteAnnotation(req, res, next) {
  return __async(this, null, function* () {
    try {
      ...
      yield annotationUseCase.execute(data2);
      res.sendStatus(204);
    } catch (error) {
      next(error);
    }
...
function getByIdAnnotation(req, res, next) {
  return __async(this, null, function* () {
    try {
      ...
      const data2 = reqParser.parse(req.params);
...
function getByUserId(req, res, next) {
  return __async(this, null, function* () {
    try {
      ...
      const data2 = reqParse.parse(req.params);
...
var ProjectRepository = class {
  ...
  create(data2) {
    return __async(this, null, function* () {
      const { name, color, ownerId, privacy, usersIds } = data2;
...
var AddUserInProjectUseCase = class {
  constructor(notificationRepository2, notificationService2, projectRepository, userRepository2) {
    this.notificationRepository = notificationRepository2;
    this.notificationService = notificationService2;
...
function addUserInProject(req, res, next) {
  return __async(this, null, function* () {
    try {
      ...
      const result = yield addUserInProjectUseCase.execute(data2);
      res.status(200).send(result);
    } catch (error) {
      next(error);
    }
...
var CreateProjectUseCase = class {
  ...
  execute(data2) {
    return __async(this, null, function* () {
      ...
      for (const element of data2.usersIds) {
        ...
        const notificationParams2 = {
          userId: element,
          senderId: data2.ownerId,
          message: `${owner.name} convidou voc\xEA para o projeto ${data2.name}`
        };
      ...
      const notificationParams = {
        userId: data2.ownerId,
        senderId: data2.ownerId,
        message: `Voc\xEA acabou de criar o projeto ${data2.name}`
      };
      const notification = yield this.notificationRepository.create(notificationParams);
      yield this.notificationService.send(notification);
      const newProject = yield this.projectRepository.create(data2);
      return newProject;
    });
  }
};
...
function createProject(req, res, next) {
  return __async(this, null, function* () {
    try {
      ...
      const result = yield createProjectUserCase.execute(data2);
      res.status(200).send(result);
    } catch (error) {
      next(error);
    }
...
var GetProjectsByUserIdUseCase = class {
  constructor(projectRepository, userRepository2) {
    this.projectRepository = projectRepository;
    this.userRepository = userRepository2;
  }
  execute(userId) {
...
function removeUserInProject(req, res, next) {
  return __async(this, null, function* () {
    try {
      ...
      const projects = yield removeUserInProjectUseCase.execute(data2);
      res.status(200).send(projects);
    } catch (error) {
      next(error);
    }
...
function makeUpdateStatusPrivacyProjectUseCase() {
  ...
  const projectRepository = new ProjectRepository(prisma2);
  const userRepository2 = new UserRepository(prisma2);
  const updateStatusPrivacyProjectUseCase = new UpdateStatusPrivacyProjectUseCase(projectRepository, userRepository2);
...
var CreateTaskUseCase = class {
  constructor(notificationRepository2, notificationService2, taskRepository, projectRepository, userRepository2) {
    this.notificationRepository = notificationRepository2;
    this.notificationService = notificationService2;
  ...
  execute(data2) {
    return __async(this, null, function* () {
      ...
      const notificationParams = {
        userId: data2.responsibleId,
        senderId: projectExists.ownerId,
        message: `Voc\xEA foi adicionado a tarefa ${data2.title}`
      };
      const notification = yield this.notificationRepository.create(notificationParams);
      yield this.notificationService.send(notification);
      const newTask = yield this.taskRepository.create(data2);
      return newTask;
    });
  }
};
...
function createTask(req, res, next) {
  return __async(this, null, function* () {
    try {
      ...
      const task = yield taskUseCase.execute(data2);
...
var DeleteTaskUseCase = class {
  constructor(taskRepository, userRepository2) {
    this.taskRepository = taskRepository;
    this.userRepository = userRepository2;
  }
...
function makeDeleteTask() {
  ...
  const taskRepository = new TaskRepository();
  const userRepository2 = new UserRepository(prisma2);
  const deleteTask2 = new DeleteTaskUseCase(taskRepository, userRepository2);
  return deleteTask2;
}
...
function ValidEmailToken2(req, res, next) {
  return __async(this, null, function* () {
    try {
      ...
      yield emailUseCase.execute(data2);
      res.sendStatus(204);
    } catch (error) {
      next(error);
    }
...
function ChangePassword2(req, res, next) {
  return __async(this, null, function* () {
    try {
      ...
      yield changePasswordUseCase.execute(data2);
      res.sendStatus(204);
    } catch (error) {
      next(error);
    }
...
var data = {
  ownerId: chance3.string({ numeric: true }),
  userId: chance3.string({ numeric: true }),
  roomId: chance3.string({ numeric: true })
};
(0, import_vitest.describe)("Added User to Room Use Case Test", () => {
  const user = {
    id: data.ownerId,
    name: chance3.name(),
    email: chance3.email(),
    phone: chance3.phone(),
    gender: chance3.gender(),
    dateBirth: chance3.date().toISOString(),
    password: chance3.guid({ version: 4 })
  };
  (0, import_vitest.it)("should successfully added user from room", () => __async(exports, null, function* () {
    import_vitest.vi.spyOn(userRepository, "getUserById").mockResolvedValue(user);
    const room = {
      id: chance3.string(),
      name: chance3.string(),
      ownerId: data.ownerId,
      updatedAt: chance3.date(),
      createdAt: chance3.date()
    };
  ...
  (0, import_vitest.it)("should return error, user added is not found", () => __async(exports, null, function* () {
  ...
  (0, import_vitest.it)("should return error, unauthorized user", () => __async(exports, null, function* () {
    ...
    yield (0, import_vitest.expect)(
      ...
      new ErrorHandler(400, "Unauthorized, Only owner can added the Chat Room")
    );
  }));
});
