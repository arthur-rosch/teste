...
function makeCreateRoomUseCase() {
  ...
  const userRepository2 = new UserRepository(prisma2);
  const chatRepository2 = new ChatRepository(prisma2);
  return new CreateRoomUseCase(notificationRepository2, notificationService2, roomRepository2, userRepository2, chatRepository2);
}
...
function makeDeleteRoomUseCase() {
  ...
  const roomRepository2 = new RoomRepository(prisma2);
  const chatRepository2 = new ChatRepository(prisma2);
  return new DeleteRoomUseCase(notificationRepository2, notificationService2, chatRepository2, roomRepository2, userRepository2);
}
...
var CreateAnnotationUseCase = class {
  ...
  execute(_0) {
    return __async(this, arguments, function* ({
      ...
      const user2 = yield this.userRepository.getUserById(userId);
      if (!user2) {
        throw new ErrorHandler(400, "User not found, try again");
      }
  ...
  execute(data2) {
    return __async(this, null, function* () {
      ...
      for (const element of data2.usersIds) {
        const user2 = yield this.userRepository.getUserById(element);
        if (!user2) {
