...
// src/use-cases/cases/project/delete.spec.ts
...
var sut;
(0, import_vitest.describe)("Delete Project Use Case", () => {
  ...
  (0, import_vitest.it)("should be able to delete a project", () => __async(exports, null, function* () {
    const { id: ownerId } = yield userRepository.create({
      name: "John Doe",
      email: "johndoe@example.com",
      password: yield (0, import_bcryptjs4.hash)("123456", 6)
    });
    ...
    yield sut.execute(project.id, ownerId);
    const deletedProject = yield projectRepository.findProjectById(project.id);
    (0, import_vitest.expect)(deletedProject).toBeNull();
  }));
  (0, import_vitest.it)("should not be able to delete a project with wrong owner id", () => __async(exports, null, function* () {
    const { id: ownerId } = yield userRepository.create({
      name: "John Doe",
      email: "johndoe@example.com",
      password: yield (0, import_bcryptjs4.hash)("123456", 6)
  ...
  (0, import_vitest.it)("should not be able to delete a non-existent project", () => __async(exports, null, function* () {
    const { id: ownerId } = yield userRepository.create({
      name: "John Doe",
      email: "johndoe@example.com",
      password: yield (0, import_bcryptjs4.hash)("123456", 6)
  ...
  (0, import_vitest.it)("should not be able to delete a project with non-existent owner", () => __async(exports, null, function* () {
    const { id: ownerId } = yield userRepository.create({
      name: "John Doe",
      email: "johndoe@example.com",
      password: yield (0, import_bcryptjs4.hash)("123456", 6)
    ...
    yield (0, import_vitest.expect)(() => sut.execute(project.id, ownerId)).rejects.toBeInstanceOf(
      ErrorHandler
    );
  }));
});
