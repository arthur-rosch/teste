...
// src/use-cases/cases/project/add-user-in-project.spec.ts
...
function makeAddUserInProjectUseCase() {
  ...
  const notificationRepository2 = new NotificationRepository(prisma2);
  const notificationService2 = new SendNotification();
  const projectRepository2 = new ProjectRepository(prisma2);
  const userRepository2 = new UserRepository(prisma2);
...
var CreateTaskUseCase = class {
  constructor(notificationRepository2, notificationService2, taskRepository, projectRepository2, userRepository2) {
    this.notificationRepository = notificationRepository2;
    this.notificationService = notificationService2;
...
var userRepository;
var sut;
(0, import_vitest.describe)("Add User In Project Use Case", () => {
  (0, import_vitest.beforeEach)(() => {
    notificationRepository = new InMemoryNotificationRepository();
    notificationService = new SendNotification(), projectRepository = new InMemoryProjectRepository();
  ...
  (0, import_vitest.it)("should be able to add a user to a project", () => __async(exports, null, function* () {
    const owner = yield userRepository.create({
      name: "John Doe",
    ...
    (0, import_vitest.expect)(response.message).toBe("User added successfully");
    const updatedProject = yield projectRepository.findProjectById(project.id);
    (0, import_vitest.expect)(updatedProject.usersIds).toContain(user.id);
  }));
  (0, import_vitest.it)("should not be able to add a user if the owner is not found", () => __async(exports, null, function* () {
    const user = yield userRepository.create({
      name: "Jane Doe",
      email: "janedoe@example.com",
      password: "hashed-password"
  ...
  (0, import_vitest.it)("should not be able to add a user if the user is not found", () => __async(exports, null, function* () {
    const owner = yield userRepository.create({
      name: "John Doe",
      email: "johndoe@example.com",
      password: "hashed-password"
  ...
  (0, import_vitest.it)("should not be able to add a user if the project is not found", () => __async(exports, null, function* () {
    const owner = yield userRepository.create({
      name: "John Doe",
      email: "johndoe@example.com",
      password: "hashed-password"
  ...
  (0, import_vitest.it)("should return a message if the user is already in the project", () => __async(exports, null, function* () {
    const owner = yield userRepository.create({
      name: "John Doe",
      email: "johndoe@example.com",
      password: "hashed-password"
    ...
    (0, import_vitest.expect)(response.message).toBe("User is already in the project");
  }));
});
