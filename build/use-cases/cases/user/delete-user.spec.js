...
// src/use-cases/cases/user/delete-user.spec.ts
...
(0, import_vitest.describe)("Delete User Test", () => {
  (0, import_vitest.it)("should delete the user successfully", () => __async(exports, null, function* () {
    import_vitest.vi.spyOn(userRepository, "getUser").mockResolvedValue(user);
    yield (0, import_vitest.expect)(sut.execute({ email: user.email })).toBeDefined();
  }));
