...
var get_projects_by_user_id_exports = {};
__export(get_projects_by_user_id_exports, {
  makeGetProjectsByUserIdUseCase: () => makeGetProjectsByUserIdUseCase
});
module.exports = __toCommonJS(get_projects_by_user_id_exports);
...
0 && (module.exports = {
  makeGetProjectsByUserIdUseCase
});
