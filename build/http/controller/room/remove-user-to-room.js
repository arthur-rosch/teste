...
var remove_user_to_room_exports = {};
__export(remove_user_to_room_exports, {
  removeUserToRoomController: () => removeUserToRoomController
});
module.exports = __toCommonJS(remove_user_to_room_exports);
...
var removeUserToRoomController = (req, res, next) => __async(void 0, null, function* () {
  const RemoveUserToRoomRequestSchema = z30.object({
    roomId: z30.string(),
    removeUserId: z30.string(),
    ownerId: z30.string()
  });
  try {
