...
var updateRoomController = (req, res, next) => __async(void 0, null, function* () {
  const updateRoomRequestSchema = z6.object({
    name: z6.string().min(3).max(50),
    ownerId: z6.string(),
    roomId: z6.string()
  });
  try {
...
var addUserToRoomController = (req, res, next) => __async(void 0, null, function* () {
  const AddUserToRoomRequestSchema = z8.object({
    roomId: z8.string(),
    addUserId: z8.string(),
    ownerId: z8.string()
  });
  ...
  return __async(this, null, function* () {
    try {
      const bodySchema = import_zod7.z.object({
        ownerId: import_zod7.z.string(),
        roomId: import_zod7.z.string(),
        roomLink: import_zod7.z.string()
      });
...
var removeUserToRoomController = (req, res, next) => __async(void 0, null, function* () {
  const RemoveUserToRoomRequestSchema = z10.object({
    roomId: z10.string(),
    removeUserId: z10.string(),
    ownerId: z10.string()
  });
  try {
...
function getMessagesByUserId(req, res, next) {
  return __async(this, null, function* () {
    try {
      const paramSchema = import_zod10.z.object({
  ...
  return __async(this, null, function* () {
    try {
      const bodySchema = import_zod11.z.object({
        information: import_zod11.z.string(),
        title: import_zod11.z.string(),
        color: import_zod11.z.string(),
  ...
  return __async(this, null, function* () {
    try {
      const bodySchema = import_zod12.z.object({
        ...
        annotationId: import_zod12.z.string()
      });
      const data = bodySchema.parse(req.body);
...
function getByIdAnnotation(req, res, next) {
  return __async(this, null, function* () {
    try {
      const reqParser = import_zod13.z.object({
...
function getByUserId(req, res, next) {
  return __async(this, null, function* () {
    try {
      const reqParse = import_zod14.z.object({
  ...
  return __async(this, null, function* () {
    try {
      const bodySchema = import_zod15.z.object({
        ownerId: import_zod15.z.string(),
        projectId: import_zod15.z.string(),
...
function createProject(req, res, next) {
  return __async(this, null, function* () {
    try {
      const privacySchema = import_zod16.z.enum([import_client22.Privacy.Private, import_client22.Privacy.Public]);
      const bodySchema = import_zod16.z.object({
        name: import_zod16.z.string(),
        color: import_zod16.z.string(),
        ownerId: import_zod16.z.string(),
        privacy: privacySchema,
        usersIds: import_zod16.z.array(import_zod16.z.string())
      });
      const data = bodySchema.parse(req.body);
...
function makeDeleteProject() {
  const prisma2 = new import_client23.PrismaClient();
  const notificationRepository = new NotificationRepository(prisma2);
  const notificationService = new SendNotification();
  const projectRepository = new ProjectRepository(prisma2);
  const userRepository = new UserRepository(prisma2);
  ...
  return __async(this, null, function* () {
    try {
      const bodySchema = import_zod19.z.object({
        ownerId: import_zod19.z.string(),
        projectId: import_zod19.z.string(),
...
function updateStatusPrivacy(req, res, next) {
  return __async(this, null, function* () {
    try {
      const privacySchema = import_zod20.z.enum([import_client27.Privacy.Private, import_client27.Privacy.Public]);
...
var prisma = new import_client28.PrismaClient();
...
function makeCreateTask() {
  const prisma2 = new import_client29.PrismaClient();
  const notificationRepository = new NotificationRepository(prisma2);
  const notificationService = new SendNotification();
...
function createTask(req, res, next) {
  return __async(this, null, function* () {
    try {
      const StatusSchema = import_zod21.z.enum([
        import_client30.Status.Analysis,
        import_client30.Status.Completed,
        import_client30.Status.Development,
        import_client30.Status.Testing,
        import_client30.Status.To_Do
      ]);
      const bodySchema = import_zod21.z.object({
        title: import_zod21.z.string(),
        information: import_zod21.z.string(),
        files: import_zod21.z.string(),
        status: StatusSchema,
        projectId: import_zod21.z.string(),
        responsibleId: import_zod21.z.string()
      });
      const data = bodySchema.parse(req.body);
...
function makeDeleteTask() {
  const prisma2 = new import_client31.PrismaClient();
  const taskRepository = new TaskRepository();
  const userRepository = new UserRepository(prisma2);
...
function updateTaskStatus(req, res, next) {
  return __async(this, null, function* () {
    try {
      const StatusSchema = import_zod23.z.enum([
        import_client33.Status.Analysis,
        import_client33.Status.Completed,
        import_client33.Status.Development,
        import_client33.Status.Testing,
        import_client33.Status.To_Do
      ]);
...
function makeValidEmailToken() {
  const prisma2 = new import_client34.PrismaClient();
  const userRepository = new UserRepository(prisma2);
  ...
  return __async(this, null, function* () {
    try {
      const bodySchema = import_zod24.z.object({
        ...
        token: import_zod24.z.string().max(5)
      });
      const data = bodySchema.parse(req.body);
  ...
  return __async(this, null, function* () {
    try {
      const bodySchema = import_zod26.z.object({
        ...
        confirmPassword: import_zod26.z.string()
      });
      const data = bodySchema.parse(req.body);
...
var deleteRoomController = (req, res, next) => __async(void 0, null, function* () {
  const paramsSchema = import_zod27.z.object({
    roomId: import_zod27.z.string()
  });
  const bodySchema = import_zod27.z.object({
    user_id: import_zod27.z.string()
  });
  try {
