...
function createProject(req, res, next) {
  return __async(this, null, function* () {
    try {
      const privacySchema = import_zod17.z.enum([import_client22.Privacy.Private, import_client22.Privacy.Public]);
...
function updateStatusPrivacy(req, res, next) {
  return __async(this, null, function* () {
    try {
      const privacySchema = import_zod21.z.enum([import_client27.Privacy.Private, import_client27.Privacy.Public]);
...
var createRoomController = (req, res, next) => __async(void 0, null, function* () {
  const CreateRoomRequestSchema = z30.object({
    name: z30.string().min(3).max(50),
    user_id: z30.string()
  });
  try {
