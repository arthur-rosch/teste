...
// src/http/controller/user/login-user.spec.ts
  ...
  execute(data) {
    return __async(this, null, function* () {
      ...
      const newUser = {
        ...
        password: yield import_bcryptjs2.default.hash(password2, 8)
      };
...
(0, import_vitest.describe)("POST /loginUser", () => {
  (0, import_vitest.it)("should login a user successfully with valid data", () => __async(exports, null, function* () {
    yield (0, import_supertest.default)(app).post("/createUser").send(body);
    const response = yield (0, import_supertest.default)(app).post("/loginUser").send({
      email: body.email,
  ...
  (0, import_vitest.it)("should return 400, credentials invalid", () => __async(exports, null, function* () {
    yield (0, import_supertest.default)(app).post("/createUser").send(body);
    const response = yield (0, import_supertest.default)(app).post("/loginUser").send({
      email: chance2.email(),
      password: body.password
