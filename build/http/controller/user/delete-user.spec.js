...
// src/http/controller/user/delete-user.spec.ts
...
(0, import_vitest.describe)("DELETE /deleteUser", () => {
  (0, import_vitest.it)("should return 204, user successfully deleted", () => __async(exports, null, function* () {
    ...
    const respDelete = yield (0, import_supertest.default)(app).delete("/deleteUser").set("Authorization", `Bearear ${token}`).send({
      email: body.email
    });
    (0, import_vitest.expect)(respDelete.status).toBe(204);
  }));
  (0, import_vitest.it)("should return 400, user invalid", () => __async(exports, null, function* () {
    ...
    (0, import_vitest.expect)(respDelete.status).toBe(400);
  }));
  (0, import_vitest.it)("should return 403, not authenticated", () => __async(exports, null, function* () {
    const respDelete = yield (0, import_supertest.default)(app).delete("/deleteUser").send({
      email: chance2.email()
    });
    (0, import_vitest.expect)(respDelete.status).toBe(403);
  }));
});
