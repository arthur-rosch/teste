...
function createTask(req, res, next) {
  return __async(this, null, function* () {
    try {
      const StatusSchema = import_zod27.z.enum([
        import_client37.Status.Analysis,
        import_client37.Status.Completed,
        import_client37.Status.Development,
        import_client37.Status.Testing,
        import_client37.Status.To_Do
      ]);
      const bodySchema = import_zod27.z.object({
        title: import_zod27.z.string(),
        information: import_zod27.z.string(),
        files: import_zod27.z.string(),
        status: StatusSchema,
        projectId: import_zod27.z.string(),
        responsibleId: import_zod27.z.string()
      });
      const data = bodySchema.parse(req.body);
