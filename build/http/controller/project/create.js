...
function updateStatusPrivacy(req, res, next) {
  return __async(this, null, function* () {
    try {
      const privacySchema = import_zod20.z.enum([import_client26.Privacy.Private, import_client26.Privacy.Public]);
...
var prisma = new import_client27.PrismaClient();
...
function makeCreateTask() {
  const prisma2 = new import_client28.PrismaClient();
  const notificationRepository = new NotificationRepository(prisma2);
  const notificationService = new SendNotification();
  ...
  return __async(this, null, function* () {
    try {
      const StatusSchema = import_zod21.z.enum([
        import_client29.Status.Analysis,
        import_client29.Status.Completed,
        import_client29.Status.Development,
        import_client29.Status.Testing,
        import_client29.Status.To_Do
      ]);
...
function createProject(req, res, next) {
  return __async(this, null, function* () {
    try {
      const privacySchema = import_zod27.z.enum([import_client37.Privacy.Private, import_client37.Privacy.Public]);
      const bodySchema = import_zod27.z.object({
        ...
        usersIds: import_zod27.z.array(import_zod27.z.string())
      });
      const data = bodySchema.parse(req.body);
